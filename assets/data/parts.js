...
{ id:'nixie-in12',  name:'IN-12 nixie tube (Soviet NOS)',      cat:'Display', price:12.00, lo:8,  hi:26, unit:'each', q:'IN-12 nixie tube', buy:['ali','amazon'],
  note:'New old stock from the 1970s - there is no modern production. Buy one more than you need and test every tube before you solder anything: a dud looks identical.' },
{ id:'nixie-hv',    name:'170 V nixie boost supply module',    cat:'Display', price:12.00, lo:8,  hi:25, unit:'each', q:'170V nixie power supply module NCH6100HV', buy:['ali','amazon'],
  note:'Turns 12 V into the ~170 V a nixie needs to strike. Buy the module rather than building it - a hand-wound flyback at 170 V is not a first high-voltage project.' },
{ id:'k155id1',     name:'K155ID1 nixie driver IC',           cat:'Display', price:4.00,  lo:2,  hi:9,  unit:'each', q:'K155ID1 nixie driver', buy:['ali'],
  note:'The only common chip that switches 170 V from a 5 V BCD input. Also Soviet NOS. A 74141 is the same part with a Western number.' },
{ id:'panel-meter', name:'Analogue panel meter, 1 mA moving coil', cat:'Display', price:6.00, lo:3, hi:16, unit:'each', q:'1mA analog panel meter DC', buy:['ali','amazon'],
  local:{se:{electrokit:'panelinstrument'}} },
{ id:'splitflap',   name:'Split-flap module kit (flaps + housing)', cat:'Display', price:28.00, lo:18, hi:60, unit:'each', q:'split flap display module kit', buy:['ali','amazon'],
  note:'Sold as a laser-cut or printed kit taking a 28BYJ-48 stepper. Printing your own is the cheaper route if you have a printer - the flap geometry is the fiddly part, not the electronics.' },
