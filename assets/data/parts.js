...
{ id:'res4k7',     name:'4.7 k ohm resistor, 1/4 W',          cat:'Passive',price:0.02, lo:0.01,hi:0.1, unit:'each', q:'4.7k ohm resistor 1/4W',    buy:['ali','amazon','digikey'],
...
{ id:'ant-868',    name:'868/915 MHz antenna + IPEX-SMA pigtail', cat:'Module', price:5.00, lo:2, hi:14, unit:'each', q:'868MHz SMA antenna IPEX pigtail', buy:['ali','amazon','electrokit'],
...
{ id:'ant-wire',   name:'Wire whip antenna (solid core, cut to length)', cat:'Passive', price:0.05, lo:0, hi:1, unit:'each', q:'22AWG solid core hookup wire', buy:['ali','amazon'],
...
{ id:'sim7600',    name:'SIM7600 LTE Cat-4 module + GNSS',    cat:'Module', price:45.00, lo:32, hi:80,  unit:'each', q:'SIM7600 LTE Cat-4 module',    buy:['ali','amazon','digikey'],
...
{ id:'ld2410',     name:'LD2410C 24 GHz mmWave presence sensor', cat:'Sensor', price:4.00, lo:2.5, hi:9, unit:'each', q:'LD2410C mmWave presence sensor', buy:['ali','amazon'],
...
{ id:'ltr390',     name:'LTR390 UV + ambient light sensor',  cat:'Sensor', price:4.50, lo:3,  hi:10, unit:'each', q:'LTR390 UV sensor I2C',       buy:['adafruit','ali','amazon'] },
...
{ id:'valve12v',   name:'12 V solenoid water valve, 1/2 in', cat:'Motion', price:9.00, lo:6,  hi:22, unit:'each', q:'12V solenoid water valve 1/2 inch', buy:['ali','amazon'],
...
{ id:'mcp4725',    name:'MCP4725 12-bit I2C DAC',            cat:'Module', price:2.50, lo:1.5, hi:8, unit:'each', q:'MCP4725 DAC module I2C',     buy:['adafruit','ali','amazon'],
...
{ id:'lm358',      name:'LM358 dual op-amp (DIP-8)',         cat:'Passive',price:0.20, lo:0.1, hi:1, unit:'each', q:'LM358 dual op amp DIP8',     buy:['ali','amazon','digikey'] },
...
{ id:'photodiode', name:'Photodiode / phototransistor',      cat:'Sensor', price:0.20, lo:0.1, hi:1, unit:'each', q:'BPW34 photodiode',           buy:['ali','amazon','digikey'] },
