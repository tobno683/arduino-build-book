...
/* --- boards ------------------------------------------------------------- */
{ id:'uno', short:'Arduino Uno',        name:'Arduino Uno R3 (or a clone)',      cat:'Board',  price:9.00,  lo:4,   hi:28,  unit:'each', q:'Arduino Uno R3',            buy:['ali','amazon','adafruit'],
...
{ id:'nano', short:'Arduino Nano',       name:'Arduino Nano (ATmega328P)',        cat:'Board',  price:4.00,  lo:2.5, hi:24,  unit:'each', q:'Arduino Nano ATmega328P',   buy:['ali','amazon','adafruit'],
...
{ id:'mega', short:'Arduino Mega 2560',       name:'Arduino Mega 2560 R3',             cat:'Board',  price:15.00, lo:11,  hi:48,  unit:'each', q:'Arduino Mega 2560',         buy:['ali','amazon','adafruit'],
  note:'Buy this only when you run out of pins or RAM. 54 digital pins, 16 analog, 8 KB SRAM.' },
{ id:'esp32', short:'ESP32 DevKit',      name:'ESP32 DevKit V1 (30-pin)',         cat:'Board',  price:5.00,  lo:3,   hi:12,  unit:'each', q:'ESP32 DevKit V1 30 pin',    buy:['ali','amazon','adafruit'],
...
{ id:'esp8266', short:'ESP8266 / D1 Mini',    name:'Wemos D1 Mini (ESP8266)',          cat:'Board',  price:3.00,  lo:2,   hi:8,   unit:'each', q:'Wemos D1 Mini ESP8266',     buy:['ali','amazon'] },
{ id:'pico', short:'Raspberry Pi Pico 2 W',       name:'Raspberry Pi Pico 2 W',            cat:'Board',  price:7.00,  lo:6,   hi:10,  unit:'each', q:'Raspberry Pi Pico 2 W',     buy:['adafruit','pimoroni','sparkfun'] },
{ id:'pro-micro', short:'Pro Micro (32U4)',  name:'Pro Micro (ATmega32U4, 5V/16MHz)', cat:'Board',  price:5.00,  lo:3,   hi:22,  unit:'each', q:'Pro Micro ATmega32U4 5V',   buy:['ali','sparkfun','amazon'],
  note:'The 32U4 can pretend to be a USB keyboard or mouse. That is the whole reason to pick it over a Nano.' },

{ id:'uno-q', short:'Arduino UNO Q',      name:'Arduino UNO Q (2 GB / 16 GB)',      cat:'Board',  price:44.00, lo:44,  hi:79,  unit:'each', q:'Arduino UNO Q',  buy:['arduino','electrokit','amazon'],
...
{ id:'ventuno-q', short:'Arduino Ventuno Q',  name:'Arduino Ventuno Q',                 cat:'Board',  price:299.00,lo:299, hi:399, unit:'each', q:'Arduino Ventuno Q', buy:['arduino','electrokit'],
...
{ id:'jetson-orin', short:'NVIDIA Jetson Orin Nano',name:'NVIDIA Jetson Orin Nano Super kit', cat:'Board',  price:249.00,lo:229, hi:349, unit:'each', q:'Jetson Orin Nano Super Developer Kit', buy:['sparkfun','amazon','arduino'],
...
{ id:'nano33ble', short:'Nano 33 BLE Sense',  name:'Arduino Nano 33 BLE Sense Rev2',    cat:'Board',  price:55.00, lo:45,  hi:75,  unit:'each', q:'Arduino Nano 33 BLE Sense Rev2', buy:['arduino','electrokit','amazon'],
...
{ id:'as5600',      name:'AS5600 magnetic angle encoder',      cat:'Sensor', price:3.00, lo:1.5, hi:9, unit:'each', q:'AS5600 magnetic encoder module', buy:['ali','amazon'],
...
{ id:'xt60',        name:'XT60 connector pairs',               cat:'Power',  price:4.00,  lo:2,  hi:10, unit:'pair', q:'XT60 connector male female pair', buy:['ali','amazon'],
