// Plate for a board you measured - The Build Book
...
/* [Board] */
board = [0, 0];   // outline of the board itself
holes = [];   // hole centres, from the board's corner
