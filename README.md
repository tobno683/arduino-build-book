...
**52 projects across 12 themes. 167 parts priced. 5 reference pages.**
...
| Page | What's in it |
|---|---|
| `index.html` | Hub: the four starting guides, the twelve themes, featured builds |
...
assets/
  ...
  data/categories.js     the twelve themes
